...
const FUNCTION_NAME = 'pattern_review'
...
function normalizeResponse(response = {}) {
  if (!response || typeof response !== 'object' || !('result' in response)) {
    return fail('cloud_response_invalid', 'CLOUD_RESPONSE_INVALID', '\u7248\u578b\u590d\u6838\u670d\u52a1\u54cd\u5e94\u65e0\u6548\u3002')
  }
  return response.result && typeof response.result === 'object'
    ? response.result
    : fail('cloud_response_invalid', 'CLOUD_RESPONSE_INVALID', '\u7248\u578b\u590d\u6838\u670d\u52a1\u54cd\u5e94\u65e0\u6548\u3002')
}

function normalizeCloudError(error = {}) {
  const code = String(error.code || error.errCode || error.errorCode || 'CLOUD_CALL_FAILED')
  return fail('cloud_call_failed', code, '\u7248\u578b\u590d\u6838\u670d\u52a1\u6682\u65f6\u4e0d\u53ef\u7528\uff0c\u8bf7\u7a0d\u540e\u91cd\u8bd5\u3002')
}

export async function callPatternReview(action = '', data = {}) {
  const session = getCurrentSession()
  if (!session || !session.token || session.authSource !== 'cloud_authenticated') {
    return fail('auth_required', 'CLOUD_ENTERPRISE_SESSION_REQUIRED', '\u8bf7\u5148\u4f7f\u7528\u4f01\u4e1a\u4e91\u7aef\u8eab\u4efd\u767b\u5f55\u3002')
  }
  ...
  if (isH5Platform()) {
    ...
    if (!authResult.ok) {
      return fail('cloud_unavailable', authResult.errorCode || 'CLOUD_WEB_AUTH_REQUIRED', '\u5f53\u524d\u7f51\u9875\u65e0\u6cd5\u8fde\u63a5\u7248\u578b\u590d\u6838\u670d\u52a1\u3002')
    }
    try {
  ...
  if (!canUseWxCloud()) {
    return fail('cloud_unavailable', 'CLOUD_UNAVAILABLE', '\u5f53\u524d\u73af\u5883\u65e0\u6cd5\u8fde\u63a5\u7248\u578b\u590d\u6838\u670d\u52a1\u3002')
  }
  try {
